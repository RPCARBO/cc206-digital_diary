...
class CustomizedIconButton extends StatefulWidget {
  const CustomizedIconButton({
    ...
    this.hoverIconColor,
    this.onPressed,
    this.showLoadingIndicator = false, ButtonStyle? style, double? splashRadius,
  });
  ...
  @override
  State<CustomizedIconButton> createState() => _CustomizedIconButtonState();
}
...
class _CustomizedIconButtonState extends State<CustomizedIconButton> {
  ...
  @override
  void didUpdateWidget(CustomizedIconButton oldWidget) {
