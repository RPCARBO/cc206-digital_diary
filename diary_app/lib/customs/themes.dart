...
abstract class CustomedTheme {
  static CustomedTheme of(BuildContext context) {
...
class LightModeTheme extends CustomedTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color secondary = const Color(0xFFD6D6D6);
  late Color tertiary = const Color(0xFF8C8C8C);
  ...
  late Color accent1 = const Color(0xFFFF5A5F);
  late Color accent2 = const Color(0xFFFFAA00);
  late Color accent3 = const Color(0xFF00A1E4);
  late Color accent4 = const Color(0xFF7BDBB2);
  ...
  late Color navbar = const Color(0xFFA72608);
  late Color background = const Color(0xFFBBC5AA);
  late Color page = const Color(0xFFDDE2C6);
}
